...
%>
	<form action="StudentAddFile" method="post" enctype="multipart/form-data">
		...
		<%
			ResultSet rs = DAOFactory.getIStudentDAOInstance().showIncomplete(sno);
			while(rs.next()){
				String task_no = rs.getString(1);
				String task_name = rs.getString(2);
				String task_url = rs.getString(3);
				Date task_date = rs.getDate(4);
				String tname = rs.getString(5);
		%>
				<tr>
				<td><%=tname %></td>
				<td><input name="task_no" value="<%=task_no %>" readonly="true"></td>
